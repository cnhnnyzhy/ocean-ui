      ...
      <div class="banner-text">
        <span>
          <a href="https://avue.top/#/pay" target="_blank">
            <img src="https://img.shields.io/badge/Avue-2.9.14-green.svg" alt="Build Status">
          </a>
          <img src="https://img.shields.io/badge/Spring%20Boot-2.7.3-yellowgreen.svg" alt="Downloads">
        ...
        <span>
          <el-collapse v-model="activeNames">
            ...
            <el-collapse-item  name="4">
              <div>基于开源LCN + Seata 分布式事务解决方案深度定制</div>
